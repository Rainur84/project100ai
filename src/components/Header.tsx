    ...
    <header className={`fixed w-full z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/news" className="text-blue-600 dark:text-blue-400 font-semibold underline underline-offset-4">
            AI News
          </Link>
        ...
        <div className="md:hidden bg-white dark:bg-gray-900 shadow-lg">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <Link to="/news" onClick={() => setIsMenuOpen(false)} className="text-blue-600 dark:text-blue-400 font-semibold underline underline-offset-4 py-2">
                AI News
              </Link>
